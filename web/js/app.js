(function (e, t) {
  ...
  function i(e, n, r, i) {
    if (st.acceptData(e)) {
      var o, a, s = st.expando, u = "string" == typeof n, l = e.nodeType, c = l ? st.cache : e, d = l ? e[s] : e[s] && s;
  ...
  function w(e, t) {
    if (t in e)return t;
    for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Tn.length; i--;)if (t = Tn[i] + n, t in e)return t;
    return r
  }
  ...
  function L(e, t, n, r) {
    ...
    }); else if (n || "object" !== st.type(t))r(e, t); else for (i in t)L(e + "[" + i + "]", t[i], n, r)
  }
  ...
  function q(e, t, n) {
    ...
    }, l = s.promise({elem: e, props: st.extend({}, t), opts: st.extend(!0, {specialEasing: {}}, n), originalProperties: t, originalOptions: n, startTime: Kn || _(), duration: n.duration, tweens: [], createTween: function (t, n) {
    ...
    for (F(c, l.opts.specialEasing); a > o; o++)if (r = nr[o].call(l, e, c, l.opts))return r;
    return I(l, c), st.isFunction(l.opts.start) && l.opts.start.call(e, l), st.fx.timer(st.extend(u, {elem: e, anim: l, queue: l.opts.queue})), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always)
  }
  ...
  function R(e, t, n) {
    var r, i, o, a, s, u, l, c, d, f = this, p = e.style, h = {}, g = [], m = e.nodeType && C(e);
  ...
  var z, Q, G = e.document, Y = e.location, U = e.jQuery, V = e.$, K = {}, J = [], Z = "1.9.0", et = J.concat, tt = J.push, nt = J.slice, rt = J.indexOf, it = K.toString, ot = K.hasOwnProperty, at = Z.trim, st = function (e, t) {
    return new st.fn.init(e, t, z)
  }, ut = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, lt = /\S+/g, ct = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, dt = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ft = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, pt = /^[\],:{}\s]*$/, ht = /(?:^|:|,)(?:\s*\[)+/g, gt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, mt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, vt = /^-ms-/, yt = /-([\da-z])/gi, bt = function (e, t) {
  ...
  st.fn = st.prototype = {jquery: Z, constructor: st, init: function (e, n, r) {
    ...
    if ("string" == typeof e) {
      ...
      if (i[1]) {
        if (n = n instanceof st ? n[0] : n, st.merge(this, st.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), ft.test(i[1]) && st.isPlainObject(n))for (i in n)st.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
        return this
      }
    ...
    if (!Q)if (Q = st.Deferred(), "complete" === G.readyState)setTimeout(st.ready); else if (G.addEventListener)G.addEventListener("DOMContentLoaded", xt, !1), e.addEventListener("load", st.ready, !1); else {
  ...
  st.Callbacks = function (e) {
    ...
    o = G.createElement("select"), a = o.appendChild(G.createElement("option")), s = f.getElementsByTagName("input")[0], i.style.cssText = "top:1px;float:left;opacity:.5", n = {getSetAttribute: "t" !== f.className, leadingWhitespace: 3 === f.firstChild.nodeType, tbody: !f.getElementsByTagName("tbody").length, htmlSerialize: !!f.getElementsByTagName("link").length, style: /top/.test(i.getAttribute("style")), hrefNormalized: "/a" === i.getAttribute("href"), opacity: /^0.5/.test(i.style.opacity), cssFloat: !!i.style.cssFloat, checkOn: !!s.value, optSelected: a.selected, enctype: !!G.createElement("form").enctype, html5Clone: "<:nav></:nav>" !== G.createElement("nav").cloneNode(!0).outerHTML, boxModel: "CSS1Compat" === G.compatMode, deleteExpando: !0, noCloneEvent: !0, inlineBlockNeedsLayout: !1, shrinkWrapBlocks: !1, reliableMarginRight: !0, boxSizingReliable: !0, pixelPosition: !1}, s.checked = !0, n.noCloneChecked = s.cloneNode(!0).checked, o.disabled = !0, n.optDisabled = !a.disabled;
    try {
      delete f.test
    } catch (p) {
      n.deleteExpando = !1
    ...
    for (d in{submit: !0, change: !0, focusin: !0})f.setAttribute(l = "on" + d, "t"), n[d + "Bubbles"] = l in e || f.attributes[l].expando === !1;
  ...
  var Nt, kt, Et = /[\t\r\n]/g, St = /\r/g, At = /^(?:input|select|textarea|button|object)$/i, Lt = /^(?:a|area)$/i, Dt = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, Mt = /^(?:checked|selected)$/i, jt = st.support.getSetAttribute, Bt = st.support.input;
  st.fn.extend({attr: function (e, t) {
    ...
    if (o && 1 === e.nodeType)for (; n = o[i++];)r = st.propFix[n] || n, Dt.test(n) ? !jt && Mt.test(n) ? e[st.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : st.attr(e, n, ""), e.removeAttribute(jt ? n : r)
    ...
    var r = st.prop(e, n), i = "boolean" == typeof r && e.getAttribute(n), o = "boolean" == typeof r ? Bt && jt ? null != i : Mt.test(n) ? e[st.camelCase("default-" + n)] : !!i : e.getAttributeNode(n);
    return o && o.value !== !1 ? n.toLowerCase() : t
  }, set: function (e, t, n) {
    return t === !1 ? st.removeAttr(e, n) : Bt && jt || !Mt.test(n) ? e.setAttribute(!jt && st.propFix[n] || n, n) : e[st.camelCase("default-" + n)] = e[n] = !0, n
  }}, Bt && jt || (st.attrHooks.value = {get: function (e, n) {
    var r = e.getAttributeNode(n);
    return st.nodeName(e, "input") ? e.defaultValue : r && r.specified ? r.value : t
  }, set: function (e, n, r) {
    return st.nodeName(e, "input") ? (e.defaultValue = n, t) : Nt && Nt.set(e, n, r)
  }}), jt || (Nt = st.valHooks.button = {get: function (e, n) {
    var r = e.getAttributeNode(n);
    return r && ("id" === n || "name" === n || "coords" === n ? "" !== r.value : r.specified) ? r.value : t
  }, set: function (e, n, r) {
    var i = e.getAttributeNode(r);
    return i || e.setAttributeNode(i = e.ownerDocument.createAttribute(r)), i.value = n += "", "value" === r || n === e.getAttribute(r) ? n : t
  }}, st.attrHooks.contenteditable = {get: Nt.get, set: function (e, t, n) {
    Nt.set(e, "" === t ? !1 : t, n)
  ...
  var Ot = /^(?:input|select|textarea)$/i, Pt = /^key/, Ht = /^(?:mouse|contextmenu)|click/, _t = /^(?:focusinfocus|focusoutblur)$/, It = /^([^.]*)(?:\.(.+)|)$/;
  st.event = {global: {}, add: function (e, n, r, i, o) {
    ...
    if (v) {
      ...
      }, s.elem = e), n = (n || "").match(lt) || [""], c = n.length; c--;)u = It.exec(n[c]) || [], h = m = u[1], g = (u[2] || "").split(".").sort(), f = st.event.special[h] || {}, h = (o ? f.delegateType : f.bindType) || h, f = st.event.special[h] || {}, d = st.extend({type: h, origType: m, data: i, handler: r, guid: r.guid, selector: o, needsContext: o && st.expr.match.needsContext.test(o), namespace: g.join(".")}, a), (p = l[h]) || (p = l[h] = [], p.delegateCount = 0, f.setup && f.setup.call(e, i, g, s) !== !1 || (e.addEventListener ? e.addEventListener(h, s, !1) : e.attachEvent && e.attachEvent("on" + h, s))), f.add && (f.add.call(e, d), d.handler.guid || (d.handler.guid = r.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), st.event.global[h] = !0;
      e = null
    }
  }, remove: function (e, t, n, r, i) {
    var o, a, s, u, l, c, d, f, p, h, g, m = st.hasData(e) && st._data(e);
    if (m && (u = m.events)) {
      for (t = (t || "").match(lt) || [""], l = t.length; l--;)if (s = It.exec(t[l]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
      ...
      } else for (p in u)st.event.remove(e, p + t[l], n, r, !0);
      st.isEmptyObject(u) && (delete m.handle, st._removeData(e, "events"))
    }
  }, trigger: function (n, r, i, o) {
    var a, s, u, l, c, d, f, p = [i || G], h = n.type || n, g = n.namespace ? n.namespace.split(".") : [];
    if (s = u = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !_t.test(h + st.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), c = 0 > h.indexOf(":") && "on" + h, n = n[st.expando] ? n : new st.Event(h, "object" == typeof n && n), n.isTrigger = !0, n.namespace = g.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : st.makeArray(r, [n]), f = st.event.special[h] || {}, o || !f.trigger || f.trigger.apply(i, r) !== !1)) {
      ...
      for (a = 0; (s = p[a++]) && !n.isPropagationStopped();)n.type = a > 1 ? l : f.bindType || h, d = (st._data(s, "events") || {})[n.type] && st._data(s, "handle"), d && d.apply(s, r), d = c && s[c], d && st.acceptData(s) && d.apply && d.apply(s, r) === !1 && n.preventDefault();
    ...
    function d(e, t) {
      ...
      for (s = e, u = [], l = N.preFilter; s;) {
        ...
        for (o in N.filter)!(r = ft[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(), i.push({value: n, type: o, matches: r}), s = s.slice(n.length));
        if (!n)break
      }
    ...
    function p(e, t, n) {
      var r = t.dir, i = n && "parentNode" === t.dir, o = $++;
      return t.first ? function (t, n, o) {
        ...
        } else for (; t = t[r];)if (1 === t.nodeType || i)if (l = t[q] || (t[q] = {}), (u = l[r]) && u[0] === c) {
    ...
    function m(e, t, n, r, o, a) {
      return r && !r[q] && (r = m(r)), o && !o[q] && (o = m(o, a)), i(function (i, a, s, u) {
        var l, c, d, f = [], p = [], h = a.length, m = i || b(t || "*", s.nodeType ? [s] : s, []), v = !e || !i && t ? m : g(m, f, e, s, u), y = n ? o || (i ? e : h || r) ? [] : a : v;
        if (n && n(v, y, s, u), r)for (l = g(y, p), r(l, [], s, u), c = l.length; c--;)(d = l[c]) && (y[p[c]] = !(v[p[c]] = d));
        if (i) {
          if (o || e) {
            if (o) {
    ...
    function v(e) {
      ...
      }]; i > s; s++)if (n = N.relative[e[s].type])c = [p(h(c), n)]; else {
    ...
    function y(e, t) {
      var n = 0, r = t.length > 0, o = e.length > 0, s = function (i, s, u, l, c) {
        var d, f, p, h = [], m = 0, v = "0", y = i && [], b = null != c, x = L, w = i || o && N.find.TAG("*", c && s.parentNode || s), C = W += null == x ? 1 : Math.E;
        ...
        if (m += v, r && v !== m) {
          ...
          if (i) {
            if (m > 0)for (; v--;)y[v] || h[v] || (h[v] = V.call(l));
            h = g(h)
          }
    ...
    function x(e, t, n, r) {
      ...
      if (!r && 1 === l.length) {
        ...
        for (i = ft.needsContext.test(e) ? -1 : o.length - 1; i >= 0 && (a = o[i], !N.relative[s = a.type]); i--)if ((u = N.find[s]) && (r = u(a.matches[0].replace(xt, wt), pt.test(o[0].type) && t.parentNode || t))) {
    ...
    var C, T, N, k, E, S, A, L, D, M, j, B, O, P, H, _, I, q = "sizzle" + -new Date, F = e.document, R = {}, W = 0, $ = 0, X = r(), z = r(), Q = r(), G = typeof t, Y = 1 << 31, U = [], V = U.pop, K = U.push, J = U.slice, Z = U.indexOf || function (e) {
      for (var t = 0, n = this.length; n > t; t++)if (this[t] === e)return t;
      return-1
    }, et = "[\\x20\\t\\r\\n\\f]", tt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = tt.replace("w", "w#"), rt = "([*^$|!~]?=)", it = "\\[" + et + "*(" + tt + ")" + et + "*(?:" + rt + et + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + nt + ")|)|)" + et + "*\\]", ot = ":(" + tt + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + it.replace(3, 8) + ")*)|.*)\\)|)", at = RegExp("^" + et + "+|((?:^|[^\\\\])(?:\\\\.)*)" + et + "+$", "g"), ut = RegExp("^" + et + "*," + et + "*"), lt = RegExp("^" + et + "*([\\x20\\t\\r\\n\\f>+~])" + et + "*"), ct = RegExp(ot), dt = RegExp("^" + nt + "$"), ft = {ID: RegExp("^#(" + tt + ")"), CLASS: RegExp("^\\.(" + tt + ")"), NAME: RegExp("^\\[name=['\"]?(" + tt + ")['\"]?\\]"), TAG: RegExp("^(" + tt.replace("w", "w*") + ")"), ATTR: RegExp("^" + it), PSEUDO: RegExp("^" + ot), CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + et + "*(even|odd|(([+-]|)(\\d*)n|)" + et + "*(?:([+-]|)" + et + "*(\\d+)|))" + et + "*\\)|)", "i"), needsContext: RegExp("^" + et + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + et + "*((?:-\\d)?\\d*)" + et + "*\\)|)(?=[^-]|$)", "i")}, pt = /[\x20\t\r\n\f]*[+~]/, ht = /\{\s*\[native code\]\s*\}/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /^(?:input|select|textarea|button)$/i, vt = /^h\d$/i, yt = /'|\\/g, bt = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, xt = /\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g, wt = function (e, t) {
      var n = "0x" + t - 65536;
    ...
    E = a.isXML = function (e) {
      ...
      return n
    }, N = a.selectors = {cacheLength: 50, createPseudo: i, match: ft, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
      ...
      return 1 === r && 0 === i ? function (e) {
        ...
        if (m) {
          ...
          if (h = [a ? m.firstChild : m.lastChild], a && y) {
            for (c = m[q] || (m[q] = {}), l = c[e] || [], p = l[0] === W && l[1], f = l[0] === W && l[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();)if (1 === d.nodeType && ++f && d === t) {
              c[e] = [W, p, f];
              break
            }
          } else if (y && (l = (t[q] || (t[q] = {}))[e]) && l[0] === W)f = l[1]; else for (; (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[q] || (d[q] = {}))[e] = [W, f]), d !== t)););
      ...
      return dt.test(e || "") || a.error("unsupported lang: " + e), e = e.replace(xt, wt).toLowerCase(), function (t) {
        var n;
        do if (n = B ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang)return n = n.toLowerCase(), n === e || 0 === n.indexOf(e + "-"); while ((t = t.parentNode) && 1 === t.nodeType);
        return!1
      }
    }), target: function (t) {
    ...
    for (C in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})N.pseudos[C] = u(C);
    for (C in{submit: !0, reset: !0})N.pseudos[C] = l(C);
  ...
  var qt = /Until$/, Ft = /^(?:parents|prev(?:Until|All))/, Rt = /^.[^:#\[\.,]*$/, Wt = st.expr.match.needsContext, $t = {children: !0, contents: !0, next: !0, prev: !0};
  st.fn.extend({find: function (e) {
    ...
    for (var n, r = 0, i = this.length, o = [], a = Wt.test(e) || "string" != typeof e ? st(e, t || this.context) : 0; i > r; r++)for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
  ...
  var Xt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", zt = / jQuery\d+="(?:null|\d+)"/g, Qt = RegExp("<(?:" + Xt + ")[\\s/>]", "i"), Gt = /^\s+/, Yt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ut = /<([\w:]+)/, Vt = /<tbody/i, Kt = /<|&#?\w+;/, Jt = /<(?:script|style|link)/i, Zt = /^(?:checkbox|radio)$/i, en = /checked\s*(?:[^=]|=\s*.checked.)/i, tn = /^$|\/(?:java|ecma)script/i, nn = /^true\/(.*)/, rn = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, on = {option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: st.support.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]}, an = f(G), sn = an.appendChild(G.createElement("div"));
  on.optgroup = on.option, on.tbody = on.tfoot = on.colgroup = on.caption = on.thead, on.th = on.td, st.fn.extend({text: function (e) {
    ...
    e = et.apply([], e);
    var i, o, a, s, u, l, c = 0, d = this.length, f = this, m = d - 1, v = e[0], y = st.isFunction(v);
    ...
    if (st.support.html5Clone || st.isXMLDoc(e) || !Qt.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (sn.innerHTML = e.outerHTML, sn.removeChild(s = sn.firstChild)), !(st.support.noCloneEvent && st.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || st.isXMLDoc(e)))for (r = b(s), i = b(e), a = 0; null != (o = i[a]); ++a)r[a] && y(o, r[a]);
    if (t)if (n)for (i = i || b(e), r = r || b(s), a = 0; null != (o = i[a]); a++)v(o, r[a]); else v(e, s);
    return r = b(s, "script"), r.length > 0 && m(r, !u && b(e, "script")), r = i = o = null, s
  }, buildFragment: function (e, t, n, r) {
    for (var i, o, a, s, u, l, c, d = e.length, p = f(t), h = [], g = 0; d > g; g++)if (o = e[g], o || 0 === o)if ("object" === st.type(o))st.merge(h, o.nodeType ? [o] : o); else if (Kt.test(o)) {
      ...
      if (!st.support.leadingWhitespace && Gt.test(o) && h.push(t.createTextNode(Gt.exec(o)[0])), !st.support.tbody)for (o = "table" !== a || Vt.test(o) ? "<table>" !== u[1] || Vt.test(o) ? 0 : s : s.firstChild, c = o && o.childNodes.length; c--;)st.nodeName(l = o.childNodes[c], "tbody") && !l.childNodes.length && o.removeChild(l);
      for (st.merge(h, s.childNodes), s.textContent = ""; s.firstChild;)s.removeChild(s.firstChild);
      s = p.lastChild
    } else h.push(t.createTextNode(o));
    for (s && p.removeChild(s), st.support.appendChecked || st.grep(b(h, "input"), x), g = 0; o = h[g++];)if ((!r || -1 === st.inArray(o, r)) && (i = st.contains(o.ownerDocument, o), s = b(p.appendChild(o), "script"), i && m(s), n))for (c = 0; o = s[c++];)tn.test(o.type || "") && n.push(o);
    return s = null, p
  }, cleanData: function (e, n) {
    for (var r, i, o, a, s = 0, u = st.expando, l = st.cache, c = st.support.deleteExpando, d = st.event.special; null != (o = e[s]); s++)if ((n || st.acceptData(o)) && (i = o[u], r = i && l[i])) {
      if (r.events)for (a in r.events)d[a] ? st.event.remove(o, a) : st.removeEvent(o, a, r.handle);
      l[i] && (delete l[i], c ? delete o[u] : o.removeAttribute !== t ? o.removeAttribute(u) : o[u] = null, J.push(i))
    }
  }});
  var un, ln, cn, dn = /alpha\([^)]*\)/i, fn = /opacity\s*=\s*([^)]*)/, pn = /^(top|right|bottom|left)$/, hn = /^(none|table(?!-c[ea]).+)/, gn = /^margin/, mn = RegExp("^(" + ut + ")(.*)$", "i"), vn = RegExp("^(" + ut + ")(?!px)[a-z%]+$", "i"), yn = RegExp("^([+-])=(" + ut + ")", "i"), bn = {BODY: "block"}, xn = {position: "absolute", visibility: "hidden", display: "block"}, wn = {letterSpacing: 0, fontWeight: 400}, Cn = ["Top", "Right", "Bottom", "Left"], Tn = ["Webkit", "O", "Moz", "ms"];
  ...
  var Ln, Dn, Mn = st.now(), jn = /\?/, Bn = /#.*$/, On = /([?&])_=[^&]*/, Pn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Hn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, _n = /^(?:GET|HEAD)$/, In = /^\/\//, qn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Fn = st.fn.load, Rn = {}, Wn = {}, $n = "*/".concat("*");
  try {
    Dn = Y.href
  } catch (Xn) {
  ...
  Ln = qn.exec(Dn.toLowerCase()) || [], st.fn.load = function (e, n, r) {
  ...
  }), st.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Dn, type: "GET", isLocal: Hn.test(Ln[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": $n, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": e.String, "text html": !0, "text json": st.parseJSON, "text xml": st.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (e, t) {
    return t ? j(j(e, st.ajaxSettings), t) : j(st.ajaxSettings, e)
  }, ajaxPrefilter: D(Rn), ajaxTransport: D(Wn), ajax: function (e, n) {
    function r(e, n, r, s) {
      var l, d, y, b, w, T = n;
    ...
    var i, o, a, s, u, l, c, d, f = st.ajaxSetup({}, n), p = f.context || f, h = f.context && (p.nodeType || p.jquery) ? st(p) : st.event, g = st.Deferred(), m = st.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", C = {readyState: 0, getResponseHeader: function (e) {
      var t;
      if (2 === x) {
  ...
  var Gn, Yn, Un = 0, Vn = e.ActiveXObject && function () {
    var e;
    ...
    if (!n.crossDomain || st.support.cors) {
      ...
      return{send: function (i, o) {
        ...
        u.send(n.hasContent && n.data || null), r = function (e, i) {
          var s, l, c, d, f;
          try {
            if (r && (i || 4 === u.readyState))if (r = t, a && (u.onreadystatechange = st.noop, Vn && delete Gn[a]), i)4 !== u.readyState && u.abort(); else {
  ...
  var Kn, Jn, Zn = /^(?:toggle|show|hide)$/, er = RegExp("^(?:([+-])=|)(" + ut + ")([a-z%]*)$", "i"), tr = /queueHooks$/, nr = [R], rr = {"*": [function (e, t) {
  ...
  st.Animation = st.extend(q, {tweener: function (e, t) {
    st.isFunction(e) ? (t = e, e = ["*"]) : e = e.split(" ");
    for (var n, r = 0, i = e.length; i > r; r++)n = e[r], rr[n] = rr[n] || [], rr[n].unshift(t)
  }, prefilter: function (e, t) {
    t ? nr.unshift(e) : nr.push(e)
  }}), st.Tween = W, W.prototype = {constructor: W, init: function (e, t, n, r, i, o) {
  ...
  }}), st.each({slideDown: $("show"), slideUp: $("hide"), slideToggle: $("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (e, t) {
    ...
    if (a)return n = a.documentElement, st.contains(n, o) ? (o.getBoundingClientRect !== t && (i = o.getBoundingClientRect()), r = X(a), {top: i.top + (r.pageYOffset || n.scrollTop) - (n.clientTop || 0), left: i.left + (r.pageXOffset || n.scrollLeft) - (n.clientLeft || 0)}) : i
  }, st.offset = {setOffset: function (e, t, n) {
    var r = st.css(e, "position");
    "static" === r && (e.style.position = "relative");
    var i, o, a = st(e), s = a.offset(), u = st.css(e, "top"), l = st.css(e, "left"), c = ("absolute" === r || "fixed" === r) && st.inArray("auto", [u, l]) > -1, d = {}, f = {};
...
})(window), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {def: "easeOutQuad", swing: function (e, t, n, r, i) {
...
var ddsmoothmenu = {arrowimages: {down: ["downarrowclass", "", 0], right: ["rightarrowclass", "images/icons/right.png"]}, transition: {overtime: 300, outtime: 300}, shadow: {enable: !1, offsetx: 5, offsety: 5}, showhidedelay: {showdelay: 200, hidedelay: 200}, detectwebkit: -1 != navigator.userAgent.toLowerCase().indexOf("applewebkit"), detectie6: document.all && !window.XMLHttpRequest, css3support: window.msPerformance || !document.all && document.querySelector, ismobile: null != navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(android)|(webOS)/i), getajaxmenu: function (e, t) {
  var n = e("#" + t.contentsource[0]);
  n.html("Loading Menu..."), e.ajax({url: t.contentsource[1], async: !0, error: function (e) {
    n.html("Error fetching content. Server Response: " + e.responseText)
  }, success: function (r) {
    n.html(r), ddsmoothmenu.buildmenu(e, t)
  }})
}, buildmenu: function (e, t) {
  var n = ddsmoothmenu, r = e("#" + t.mainmenuid + ">ul");
  r.parent().get(0).className = t.classname || "ddsmoothmenu";
  var i = r.find("ul").parent();
  if (i.hover(function () {
    e(this).children("a:eq(0)").addClass("noborder selected")
  }, function () {
    e(this).children("a:eq(0)").removeClass("noborder selected")
  }), i.each(function (r) {
    var i = e(this).css({zIndex: 100 - r}), o = e(this).find("ul:eq(0)").css({display: "block"});
    if (o.data("timers", {}), this._dimensions = {w: this.offsetWidth, h: this.offsetHeight, subulw: o.outerWidth(), subulh: o.outerHeight()}, this.istopheader = 1 == i.parents("ul").length ? !0 : !1, o.css({top: this.istopheader && "v" != t.orientation ? this._dimensions.h + "px" : 0}), i.children("a:eq(0)").css(this.istopheader ? {} : {}).append('<img src="' + (this.istopheader && "v" != t.orientation ? n.arrowimages.down[1] : n.arrowimages.right[1]) + '" class="' + (this.istopheader && "v" != t.orientation ? n.arrowimages.down[0] : n.arrowimages.right[0]) + '" style="border:0;" />'), n.shadow.enable && !n.css3support) {
      if (this._shadowoffset = {x: this.istopheader ? o.offset().left + n.shadow.offsetx : this._dimensions.w, y: this.istopheader ? o.offset().top + n.shadow.offsety : i.position().top}, this.istopheader)$parentshadow = e(document.body); else {
        var a = i.parents("li:eq(0)");
        $parentshadow = a.get(0).$shadow
      }
      this.$shadow = e('<div class="ddshadow' + (this.istopheader ? " toplevelshadow" : "") + '"></div>').prependTo($parentshadow).css({left: this._shadowoffset.x + "px", top: this._shadowoffset.y + "px"})
    }
    i.hover(function () {
      var r = o, a = i.get(0);
      clearTimeout(r.data("timers").hidetimer), r.data("timers").showtimer = setTimeout(function () {
        a._offsets = {left: i.offset().left, top: i.offset().top};
        var o = a.istopheader && "v" != t.orientation ? 0 : a._dimensions.w;
        if (o = a._offsets.left + o + a._dimensions.subulw > e(window).width() ? a.istopheader && "v" != t.orientation ? -a._dimensions.subulw + a._dimensions.w : -a._dimensions.w : o, 1 >= r.queue().length && (r.css({left: o + "px", width: a._dimensions.subulw + "px"}).animate({height: "show", opacity: "show"}, ddsmoothmenu.transition.overtime), n.shadow.enable && !n.css3support)) {
          var s = a.istopheader ? r.offset().left + ddsmoothmenu.shadow.offsetx : o, u = a.istopheader ? r.offset().top + n.shadow.offsety : a._shadowoffset.y;
          !a.istopheader && ddsmoothmenu.detectwebkit && a.$shadow.css({opacity: 1}), a.$shadow.css({overflow: "", width: a._dimensions.subulw + "px", left: s + "px", top: u + "px"}).animate({height: a._dimensions.subulh + "px"}, ddsmoothmenu.transition.overtime)
        }
      }, ddsmoothmenu.showhidedelay.showdelay)
    }, function () {
      var e = o, t = i.get(0);
      clearTimeout(e.data("timers").showtimer), e.data("timers").hidetimer = setTimeout(function () {
        e.animate({height: "hide", opacity: "hide"}, ddsmoothmenu.transition.outtime), n.shadow.enable && !n.css3support && (ddsmoothmenu.detectwebkit && t.$shadow.children("div:eq(0)").css({opacity: 0}), t.$shadow.css({overflow: "hidden"}).animate({height: 0}, ddsmoothmenu.transition.outtime))
      }, ddsmoothmenu.showhidedelay.hidedelay)
    })
  }), n.shadow.enable && n.css3support)for (var o = e("#" + t.mainmenuid + " ul li ul"), a = parseInt(n.shadow.offsetx) + "px " + parseInt(n.shadow.offsety) + "px 5px #aaa", s = ["boxShadow", "MozBoxShadow", "WebkitBoxShadow", "MsBoxShadow"], u = 0; s.length > u; u++)o.css(s[u], a);
  r.find("ul").css({display: "none", visibility: "visible"})
}, init: function (e) {
  if ("object" == typeof e.customtheme && 2 == e.customtheme.length) {
    var t = "#" + e.mainmenuid, n = "v" == e.orientation ? t : t + ", " + t;
    document.write('<style type="text/css">\n' + n + " ul li a {background:" + e.customtheme[0] + ";}\n" + t + " ul li a:hover {background:" + e.customtheme[1] + ";}\n" + "</style>")
  }
  this.shadow.enable = document.all && !window.XMLHttpRequest ? !1 : this.shadow.enable, jQuery(document).ready(function (t) {
...
(function (e) {
    ...
    e.data(t, "flexslider", r), r.init = function () {
      function i(e) {
        if (!r.animating && (39 == e.keyCode || 37 == e.keyCode)) {
          if (39 == e.keyCode)var t = r.getTarget("next"); else if (37 == e.keyCode)var t = r.getTarget("prev");
      ...
      if (r.vars = e.extend({}, e.flexslider.defaults, n), e.data(t, "flexsliderInit", !0), r.container = e(".slides", r).eq(0), r.slides = e(".slides:first > li", r), r.count = r.slides.length, r.animating = !1, r.currentSlide = r.vars.slideToStart, r.animatingTo = r.currentSlide, r.atEnd = 0 == r.currentSlide ? !0 : !1, r.eventType = "ontouchstart"in document.documentElement ? "touchstart" : "click", r.cloneCount = 0, r.cloneOffset = 0, r.manualPause = !1, r.vertical = "vertical" == r.vars.slideDirection, r.prop = r.vertical ? "top" : "marginLeft", r.args = {}, r.transitions = "webkitTransition"in document.body.style && r.vars.useCSS, r.transitions && (r.prop = "-webkit-transform"), "" != r.vars.controlsContainer && (r.controlsContainer = e(r.vars.controlsContainer).eq(e(".slides").index(r.container)), r.containerExists = r.controlsContainer.length > 0), "" != r.vars.manualControls && (r.manualControls = e(r.vars.manualControls, r.containerExists ? r.controlsContainer : r), r.manualExists = r.manualControls.length > 0), r.vars.randomize && (r.slides.sort(function () {
        ...
        r.transitions && r.setTransition(0), r.css({overflow: "hidden"}), r.vars.animationLoop && (r.cloneCount = 2, r.cloneOffset = 1, r.container.append(r.slides.filter(":first").clone().addClass("clone")).prepend(r.slides.filter(":last").clone().addClass("clone"))), r.newSlides = e(".slides:first > li", r);
        var u = -1 * (r.currentSlide + r.cloneOffset);
        r.vertical ? (r.newSlides.css({display: "block", width: "100%", "float": "left"}), r.container.height(200 * (r.count + r.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
          r.css({position: "relative"}).height(r.slides.filter(":first").height()), r.args[r.prop] = r.transitions ? "translate3d(0," + u * r.height() + "px,0)" : u * r.height() + "px", r.container.css(r.args)
          ...
          r.newSlides.width(r.width()).css({"float": "left", display: "block"})
        }, 100))
      } else r.transitions = !1, r.slides.css({width: "100%", "float": "left", marginRight: "-100%"}).eq(r.currentSlide).fadeIn(r.vars.animationDuration);
      if (r.vars.controlNav) {
        if (r.manualExists)r.controlNav = r.manualControls; else {
      ...
      if (r.vars.keyboardNav && 1 == e("ul.slides").length && e(document).bind("keyup", i), r.vars.mousewheel && (r.mousewheelEvent = /Firefox/i.test(navigator.userAgent) ? "DOMMouseScroll" : "mousewheel", r.bind(r.mousewheelEvent, function (e) {
        ...
        var t = e.detail ? -1 * e.detail : e.originalEvent.wheelDelta / 40, n = 0 > t ? r.getTarget("next") : r.getTarget("prev");
        r.canAdvance(n) && r.flexAnimate(n, r.vars.pauseOnAction)
      ...
      r.container.css({"-webkit-transition-duration": e / 1e3 + "s"})
    }, r.init()
  }, e.flexslider.defaults = {animation: "fade", slideDirection: "horizontal", slideshow: !0, slideshowSpeed: 7e3, animationDuration: 600, directionNav: !0, controlNav: !0, keyboardNav: !0, mousewheel: !1, prevText: "Previous", nextText: "Next", pausePlay: !1, pauseText: "Pause", playText: "Play", randomize: !1, slideToStart: 0, animationLoop: !0, pauseOnAction: !0, pauseOnHover: !1, useCSS: !0, touch: !0, controlsContainer: "", manualControls: "", start: function () {
  }, before: function () {
  }, after: function () {
  }, end: function () {
  ...
  e.fn.colorTip = function (r) {
    var i = {color: "yellow", timeout: 0}, o = ["red", "green", "blue", "white", "yellow", "black"];
    return r = e.extend(i, r), this.each(function () {
      var i = e(this);
      if (!i.data("tooltip"))return!0;
      var a = new t, s = new n(i.data("tooltip"));
      i.append(s.generate()).addClass("colorTipContainer");
      for (var u = !1, l = 0; o.length > l; l++)if (i.hasClass(o[l])) {
        u = !0;
        break
      }
  ...
  var e = function (e, t) {
    ...
    function o(e) {
      f++;
      var t = e.children.length, n = "", a = "", h = f - 1;
      if (t) {
        if (h) {
          for (; h--;)a += c;
          a += " "
        ...
        for (var g = 0; t > g; g++) {
          ...
          if (m !== void 0) {
            var v = m.innerText || m.textContent, y = "";
    ...
    if (e = document.getElementById(e), e && r(e)) {
      ...
      var a = t || {}, s = a.activeclass || "active", u = "boolean" == typeof a.autoselect ? a.autoselect : !0, l = "boolean" == typeof a.nested ? a.nested : !0, c = a.indent || "→", d = a.label || "- Navigation -", f = 0, p = " selected ";
  ...
  e.fn.qrcode = function (t) {
    ...
    n.prototype = {getLength: function () {
      ...
      for (var n = -1; 7 >= n; n++)if (!(-1 >= e + n || e + n >= this.moduleCount))for (var r = -1; 7 >= r; r++)-1 >= t + r || t + r >= this.moduleCount || (this.modules[e + n][t + r] = n >= 0 && 6 >= n && (0 == r || 6 == r) || r >= 0 && 6 >= r && (0 == n || 6 == n) || n >= 2 && 4 >= n && r >= 2 && 4 >= r ? !0 : !1)
      ...
      for (e = e.createEmptyMovieClip(t, n), this.make(), t = 0; this.modules.length > t; t++)for (var n = 1 * t, r = 0; this.modules[t].length > r; r++) {
        var i = 1 * r;
      ...
      for (var e = u.getPatternPosition(this.typeNumber), t = 0; e.length > t; t++)for (var n = 0; e.length > n; n++) {
        var r = e[t], i = e[n];
        if (null == this.modules[r][i])for (var o = -2; 2 >= o; o++)for (var a = -2; 2 >= a; a++)this.modules[r + o][i + a] = -2 == o || 2 == o || -2 == a || 2 == a || 0 == o && 0 == a ? !0 : !1
      }
      ...
      for (var n = 0, r = 0, o = 0, a = Array(t.length), s = Array(t.length), l = 0; t.length > l; l++) {
        var c = t[l].dataCount, d = t[l].totalCount - c, r = Math.max(r, c), o = Math.max(o, d);
        a[l] = Array(c);
      ...
      for (n = Array(l), f = c = 0; r > f; f++)for (l = 0; t.length > l; l++)a[l].length > f && (n[c++] = a[l][f]);
      for (f = 0; o > f; f++)for (l = 0; t.length > l; l++)s[l].length > f && (n[c++] = s[l][f]);
      return n
    }, s = 4;
    for (var u = {PATTERN_POSITION_TABLE: [
      [],
      [6, 18],
      [6, 22],
      [6, 26],
    ...
    ], G15: 1335, G18: 7973, G15_MASK: 21522, getBCHTypeInfo: function (e) {
      ...
      for (var t = e.getModuleCount(), n = 0, r = 0; t > r; r++)for (var i = 0; t > i; i++) {
        for (var o = 0, a = e.isDark(r, i), s = -1; 1 >= s; s++)if (!(0 > r + s || r + s >= t))for (var u = -1; 1 >= u; u++)0 > i + u || i + u >= t || 0 == s && 0 == u || a == e.isDark(r + s, i + u) && o++;
        o > 5 && (n += 3 + o - 5)
      }
      for (r = 0; t - 1 > r; r++)for (i = 0; t - 1 > i; i++)o = 0, e.isDark(r, i) && o++, e.isDark(r + 1, i) && o++, e.isDark(r, i + 1) && o++, e.isDark(r + 1, i + 1) && o++, (0 == o || 4 == o) && (n += 3);
      ...
      for (i = o = 0; t > i; i++)for (r = 0; t > r; r++)e.isDark(r, i) && o++;
    ...
    }, EXP_TABLE: Array(256), LOG_TABLE: Array(256)}, c = 0; 8 > c; c++)l.EXP_TABLE[c] = 1 << c;
    ...
    return i.prototype = {get: function (e) {
      ...
      for (var t = Array(this.getLength() + e.getLength() - 1), n = 0; this.getLength() > n; n++)for (var r = 0; e.getLength() > r; r++)t[n + r] ^= l.gexp(l.glog(this.get(n)) + l.glog(e.get(r)));
      return new i(t, 0)
    }, mod: function (e) {
      ...
      for (var r = n.length / 3, i = [], a = 0; r > a; a++)for (var s = n[3 * a + 0], u = n[3 * a + 1], l = n[3 * a + 2], c = 0; s > c; c++)i.push(new o(u, l));
      return i
    ...
    }}, "string" == typeof t && (t = {text: t}), t = e.extend({}, {render: "canvas", width: 256, height: 256, typeNumber: -1, correctLevel: 2, background: "#ffffff", foreground: "#000000"}, t), this.each(function () {
      var n;
      if ("canvas" == t.render) {
        n = new r(t.typeNumber, t.correctLevel), n.addData(t.text), n.make();
        var i = document.createElement("canvas");
        i.width = t.width, i.height = t.height;
        for (var o = i.getContext("2d"), a = t.width / n.getModuleCount(), s = t.height / n.getModuleCount(), u = 0; n.getModuleCount() > u; u++)for (var l = 0; n.getModuleCount() > l; l++) {
          o.fillStyle = n.isDark(u, l) ? t.foreground : t.background;
          var c = Math.ceil((l + 1) * a) - Math.floor(l * a), d = Math.ceil((u + 1) * a) - Math.floor(u * a);
          o.fillRect(Math.round(l * a), Math.round(u * s), c, d)
        }
      } else for (n = new r(t.typeNumber, t.correctLevel), n.addData(t.text), n.make(), i = e("<table></table>").css("width", t.width + "px").css("height", t.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", t.background), o = t.width / n.getModuleCount(), a = t.height / n.getModuleCount(), s = 0; n.getModuleCount() > s; s++)for (u = e("<tr></tr>").css("height", a + "px").appendTo(i), l = 0; n.getModuleCount() > l; l++)e("<td></td>").css("width", o + "px").css("background-color", n.isDark(s, l) ? t.foreground : t.background).appendTo(u);
      n = i, jQuery(n).appendTo(this)
    })
  }
}(jQuery), function (e) {
  "use strict";
  var t, n = e.Base64, r = "2.1.2";
  "undefined" != typeof module && module.exports && (t = require("buffer").Buffer);
  var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = function (e) {
    for (var t = {}, n = 0, r = e.length; r > n; n++)t[e.charAt(n)] = n;
    return t
  }(i), a = String.fromCharCode, s = function (e) {
    if (2 > e.length) {
  ...
  }, u = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, l = function (e) {
    return e.replace(u, s)
  }, c = function (e) {
    var t = [0, 2, 1][e.length % 3], n = e.charCodeAt(0) << 16 | (e.length > 1 ? e.charCodeAt(1) : 0) << 8 | (e.length > 2 ? e.charCodeAt(2) : 0), r = [i.charAt(n >>> 18), i.charAt(63 & n >>> 12), t >= 2 ? "=" : i.charAt(63 & n >>> 6), t >= 1 ? "=" : i.charAt(63 & n)];
    return r.join("")
  }, d = e.btoa ? function (t) {
    return e.btoa(t)
  } : function (e) {
    ...
    return p(e, !0)
  }, g = RegExp(["[À-ß][-¿]", "[à-ï][-¿]{2}", "[ð-÷][-¿]{3}"].join("|"), "g"), m = function (e) {
    switch (e.length) {
      case 4:
    ...
    var t = e.length, n = t % 4, r = (t > 0 ? o[e.charAt(0)] << 18 : 0) | (t > 1 ? o[e.charAt(1)] << 12 : 0) | (t > 2 ? o[e.charAt(2)] << 6 : 0) | (t > 3 ? o[e.charAt(3)] : 0), i = [a(r >>> 16), a(255 & r >>> 8), a(255 & r)];
  ...
  if (e.Base64 = {VERSION: r, atob: b, btoa: d, fromBase64: w, toBase64: p, utob: l, encode: p, encodeURI: h, btou: v, decode: w, noConflict: C}, "function" == typeof Object.defineProperty) {
    var T = function (e) {
  ...
  e(document).ready(function () {
    e("head").append("<link href='http://fonts.googleapis.com/css?family=Source+Code+Pro:200,400,700|Iceland|Titillium+Web:400,600,600italic' rel='stylesheet' type='text/css'>"), ddsmoothmenu.init({mainmenuid: "menu", orientation: "h", classname: "navigation", contentsource: "markup"}), e("html").addClass("js"), selectnav("nav", {label: "- Navigation Menu - ", nested: !0, indent: "-", autoselect: !1})
  }), e("[data-tooltip]").colorTip({color: "white"}), e("#qrcode-1").qrcode("ss://YmYtY2ZiOnRlc3RAMTkyLjE2OC4xMDAuMTo4ODg4"), e("#uri-plain").on("keyup change", function () {
    var t = "ss://" + Base64.encode(e(this).val().replace("ss://", "")).replace(/=/g, "");
    e("#uri-encoded").val(t), e("#qrcode-gen").empty(), e("#qrcode-gen").qrcode(t)
  }), e(window).load(function () {
    e(".flexslider").flexslider({animation: "fade", animationLoop: !0, slideshow: !0, slideshowSpeed: 4500, animationSpeed: 700, pauseOnHover: !0, pauseOnAction: !1, controlNav: !0, directionNav: !1, controlsContainer: ".flex-container"}), e("#uri-plain").change()
  })
}(jQuery);